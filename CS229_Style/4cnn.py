...
class ThreeLayerFancyNet(object):
  ...
  def loss(self, X, y=None):
    ...
    X_1, cache_large_conv = conv_relu_pool_forward(X_combine, theta_large, 
        theta_large_0, large_conv_param, pool_param)

    ####New Convolution Layer:
    X_loc_2, cache_loc_2 = conv_relu_forward(X_1, theta_loc_2, theta_loc_2_0, conv_param)
    X_per_2, cache_per_2 = conv_relu_forward(X_1, theta_per_2, theta_per_2_0, conv_param)

    X_loc_large_2, cache_zero_2 = zero_weave_forward(X_loc_2, weave_param)
    X_per_weave_2, cache_weave_2 = array_weave_fast_forward(X_per_2, weave_param)

    X_combine_2, cache_combine_2 = array_sum_fowards(X_loc_large_2, X_per_weave)

    X_2, cache_large_conv_2 = conv_relu_pool_forward(X_combine_2, theta_large_2, 
        theta_large_2_0, large_conv_param, pool_param)
